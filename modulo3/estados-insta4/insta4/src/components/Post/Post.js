...
function Post(props){
  ...
  const onClickComentario = () => {
    ...
    if(comentando) {
      componenteComentario = <SecaoComentario aoEnviar={aoEnviarComentario} comentarios={comentarioUsuario} onChangeComentario = {handlecomentarioUsuario}/>
    }
  ...
  let iconeCurtida
    ...
    if(comentando) {
      componenteComentario = <SecaoComentario aoEnviar={aoEnviarComentario} onChangeComentario={handlecomentarioUsuario}/>
    }
